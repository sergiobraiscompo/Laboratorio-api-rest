...
public class IParticipantQueriesService : QueryServiceBase, Abstractions.Queries.IParticipantQueriesService
{
    ...
    public IParticipantQueriesService(IOptionsSnapshot<DapperConfig> dapperConfig, ContentInspector contentInspector) : base(dapperConfig)
    {
